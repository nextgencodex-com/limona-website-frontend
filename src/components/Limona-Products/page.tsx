      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <main className="lg:w-3/4">
            ...
            {/* Products Grid - Show coming soon overlay only for categories marked as coming soon (exclude All Products) */}
            {(selectedCategory !== 'All Products' && comingSoonCategories.includes(selectedCategory)) || 
              ...
              <div className="relative min-h-[600px]">
                ...
                <div className="absolute inset-0 z-50 flex items-center justify-center bg-white/95 backdrop-blur-sm animate-fadeIn rounded-lg">
                  <div className="max-w-md mx-auto p-6 md:p-8 text-center animate-slideUp">
                    <div className="p-4 rounded-full w-20 h-20 mx-auto mb-6 flex items-center justify-center bg-gradient-to-br from-[#FACC15] to-[#FCC900] shadow-lg animate-pulse">
                      <Clock className="text-gray-900" size={40} />
                    </div>
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 tracking-[0.07em] font-geologica animate-bounce-subtle" style={{ letterSpacing: '0.07em', color: '#FCC900' }}>
                      Coming Soon
                    </h3>
                    <p className="text-gray-700 text-base md:text-lg mb-6 tracking-[0.07em] font-geologica" style={{ letterSpacing: '0.07em' }}>
                    ...
                    <a 
                      ...
                      className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 font-bold tracking-[0.07em] font-geologica"
                      style={{ letterSpacing: '0.07em' }}
                    >
