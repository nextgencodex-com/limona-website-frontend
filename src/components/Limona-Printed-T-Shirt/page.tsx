...
const LimonaPrintedTShirt = () => {
  const [activeTab, setActiveTab] = useState<'customize' | 'printed'>('printed');
  ...
  const handleSubmitViaWhatsApp = () => {
    ...
    const message = `*Printed T-Shirt Order Request*\n\n` +
      `*Name:* ${formData.fullName}\n` +
      `*Phone:* ${formData.phoneNumber}\n` +
      `*Design URL:* ${formData.designUrl}\n` +
      `*T-Shirt Color:* ${selectedColor || 'Not selected'}\n` +
            ...
            <div className="max-w-6xl mx-auto">
              <div className="relative rounded-[35px] overflow-visible shadow-xl border border-gray-300 h-[294px]">
                ...
                <img
                  ...
                  alt="Printed T-Shirt Collection"
                  className="absolute inset-0 w-full h-full object-cover rounded-[35px]"
                  onError={(e) => {
                    e.currentTarget.src = `https://placehold.co/1920x600/1a1a1a/ffffff?text=Printed+T-Shirt+Collection`;
                  }}
                />
                  ...
                  <div className="hidden lg:block lg:w-1/2 relative flex items-center justify-end h-full">
                    <div className="relative" style={{ marginRight: '40px' }}>
                      <img
                        ...
                        onError={(e) => {
                          e.currentTarget.src = `https://placehold.co/600x800/EEE/31343C?text=Printed+T-Shirts`;
                        }}
                        style={{
        ...
        <section className="py-8">
          <div className="container mx-auto px-4 md:px-8">
            <div className="flex justify-center gap-4">
              <button
                onClick={() => window.location.href = '/Customize-Your-Own'}
                className={`px-8 py-3 rounded-md text-sm font-medium transition-all tracking-[0.07em] border mr-2 ${
                  activeTab === 'customize'
                ...
                <div className="flex-1 rounded-lg p-6">
                  ...
                  <div className="mt-6">
                    <div className="flex items-center justify-center flex-wrap gap-3">
                      ...
                      {/* Additional 4 colors */}
                      {showAllColors && colorOptions.slice(4).map((color) => (
                        <button
                          key={color.name}
                          onClick={() => setSelectedColor(color.name)}
                          className={`w-10 h-10 rounded-full border-2 transition-all flex-shrink-0 ${
                      ...
                      <button
                        ...
                        aria-label={showAllColors ? "Show less colors" : "Show more colors"}
                      >
                    ...
                    {selectedColor && (
                      <p className="text-sm text-gray-700 text-center mt-2 tracking-[0.07em]">
        ...
        <section className="py-8 bg-white font-geologica tracking-[0.07em] px-4">
          <div className="relative rounded-4xl overflow-hidden shadow-lg border border-gray-200 h-[120px]">
            <img
              ...
              onError={(e) => {
                e.currentTarget.src = `https://placehold.co/600x200/1a1a1a/ffffff?text=Printed+T-Shirts`;
              }}
            />
        ...
        <section className="py-6 px-4">
          <div className="space-y-6">
            ...
            <div>
              ...
              {/* Color Selection - UNDER Design Preview */}
              <div className="mt-4">
                <h3 className="text-sm font-medium text-gray-700 mb-2 tracking-[0.07em]">
                ...
                {selectedColor && (
                  <p className="text-xs text-gray-700 text-center mt-2 tracking-[0.07em]">
                    Selected: <span className="font-semibold">{selectedColor}</span>
                  </p>
                )}
              </div>
...
export default LimonaPrintedTShirt;